                    ...
                    <div class="logo">
                        <router-link to="/">
                            <img
                                ...
                                src="http://vehicle-enrollment-app.test/assets/img/logo-white.png"
                                alt="#"
                            />
                        </router-link>
                        <div @click="catchDrawerHandler" class="nftmax__sicon close-icon">
                            <img src="http://vehicle-enrollment-app.test/assets/img/menu-toggle.svg" alt="#" />
                        </div>
                    </div>
